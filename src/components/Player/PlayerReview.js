...
const PlayerReview = ({user: {avatar_url, html_url, login}, clearUser}) => {
    return (
        <div className="player__preview">
            <img className="player__preview-image" src={avatar_url ? avatar_url : 'https://avatars0.githubusercontent.com/u/59271904?v=4'} />
            <a href={html_url} className="player__preview-name"><p className="h5">{login}</p></a>
